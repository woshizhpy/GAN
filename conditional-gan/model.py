...
class Generator(object):
	...
	def __call__(self, seq_idx, z, reuse=False, train=True):
		...
		with tf.variable_scope("g_net") as scope:
			...
			# Potential resize layer, never tested yet
			# resize_0 = tf.image.resize_images(conv4, (128, 128, 3), method=0)
			# resize_1 = tf.image.resize_images(conv4, (128, 128, 3), method=1)
			# resize_2 = tf.image.resize_images(conv4, (128, 128, 3), method=2)
			# resize_3 = tf.image.resize_images(conv4, (128, 128, 3), method=3)

			print('resize0 size {}'.format(resize0.shape()))
